...
export const ShiftActions = ({ calData, disabled, transparent }: IProps) => {
  const CalendarButton = ({ type }: { type: "google" | "outlook" }) => {
    const onClick = () =>
      window.open(
        type === "google"
          ? generateGoogleCalendarLink(calData)
          : generateOutlookCalendarLink(calData)
      );
    const icon = {
  ...
  return (
    <>
      <Grid.Container justify="space-between" alignItems="center">
        ...
        >
          <Grid>
            <CalendarButton type="google" />
          </Grid>
          <Grid>
            <CalendarButton type="outlook" />
          </Grid>
        </Grid.Container>
      </Grid.Container>
    </>
